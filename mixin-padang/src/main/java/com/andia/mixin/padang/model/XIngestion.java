...
public class XIngestion extends XSource {

	public static String XCLASSNAME = Padang.getEClassName("XIngestion");

	public static EAttribute FEATURE_ORIGIN = new EAttribute("origin", EAttribute.STRING);
	...
	public XIngestion() {
		super(Padang.createEClass(XCLASSNAME), new EFeature[] {
				XIngestion.FEATURE_ORIGIN,
				XIngestion.FEATURE_OPTIONS
		});
	}
	...
	public void setOrigin(String newOrigin) {
		...
		this.eSetNotify(XIngestion.FEATURE_ORIGIN, oldOrigin, newOrigin);
	}
