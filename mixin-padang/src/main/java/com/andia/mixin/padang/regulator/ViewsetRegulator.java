...
public class ViewsetRegulator extends EObjectRegulator {

	@Override
	public XViewset getModel() {
		return (XViewset) super.getModel();
	}

	@Override
	public ViewsetOutset getOutset() {
		return (ViewsetOutset) super.getOutset();
	}

	@Override
	protected Object[] getModelChildren() {
		XViewset model = getModel();
		XMixture mixture = model.getMixture();
		return new Object[] { mixture };
	}
