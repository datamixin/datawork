...
public abstract class ForeseeRegulator extends EObjectRegulator {

	@Override
	public XForesee getModel() {
		return (XForesee) super.getModel();
	}

	@Override
	public ForeseeOutset getOutset() {
		return (ForeseeOutset) super.getOutset();
	}
