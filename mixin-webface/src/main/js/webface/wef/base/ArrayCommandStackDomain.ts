...
import ArrayCommandStack from "webface/wef/base/ArrayCommandStack";

import ModelSynchronizer from "webface/model/ModelSynchronizer";

export default class ArrayCommandStackDomain implements EditDomain {

    private commandStack: CommandStack = null;

    constructor(synchronizer?: ModelSynchronizer) {
        this.commandStack = new ArrayCommandStack(synchronizer);
    }
