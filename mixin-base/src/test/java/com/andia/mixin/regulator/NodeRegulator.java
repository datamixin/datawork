...
public class NodeRegulator extends EObjectRegulator {

	@Override
	public MNode getModel() {
		return (MNode) super.getModel();
	}

	@Override
	public NodeOutset getOutset() {
		return (NodeOutset) super.getOutset();
	}

	@Override
	protected Object[] getModelChildren() {
		MNode model = getModel();
		MValue state = model.getState();
