...
export default class ConsoleTaskItem extends BaseTaskItem {

    constructor(key: TaskKey, content: TaskContent, site: WorkspaceSite) {
        super(key, content, "mdi-home-analytics", site);
    }
