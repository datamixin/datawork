...
public interface ReceiptAnchor {

	public void assignInput(String name, SExpression value) throws ProminerException;

	public void renameInput(String oldName, String newName) throws ProminerException;

	public void removeInput(String name) throws ProminerException;
