...
public class BinaryDataType extends BaseDataType<byte[]> {
	...
	public void setValue(PreparedStatement statement, int index, Object value) {
		try {
			...
			throw new QueryException("Fail setting bytes parameter [" + index + "]", e);
		}
	}

	@Override
	public String toLiteral(Object value) {
		throw new UnsupportedOperationException("Cannot create literal for binary data type");
	}
