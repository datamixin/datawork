...
public class UUIDDataType extends BaseDataType<UUID> {
	...
	public void setValue(PreparedStatement statement, int index, Object value) {
		try {
			...
			throw new QueryException("Fail setting uuid parameter [" + index + "]", e);
		}
	}

	@Override
	public String toLiteral(Object value) {
		throw new UnsupportedOperationException("Cannot create literal for UUID data type");
	}
