...
public class CharDataType extends BaseDataType<UUID> {

	private int length = 0;

	public CharDataType() {
		super(String.class, "CHAR");
	}

	public CharDataType length(int length) {
		this.length = length;
		return this;
	}
	...
	public void setValue(PreparedStatement statement, int index, Object value) {
		try {
			...
			throw new QueryException("Fail setting char parameter [" + index + "]", e);
		}
	}
