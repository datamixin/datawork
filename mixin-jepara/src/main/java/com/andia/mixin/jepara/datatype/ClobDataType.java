...
public class ClobDataType extends BaseDataType<Clob> {

	public ClobDataType() {
		super(Clob.class, "CLOB");
	}
	...
	public void setValue(PreparedStatement statement, int index, Object value) {
		try {
			...
			throw new QueryException("Fail setting clob parameter [" + index + "]", e);
		}
	}

	@Override
	public String toLiteral(Object value) {
		throw new UnsupportedOperationException("Cannot create literal for CLOB data type");
	}
