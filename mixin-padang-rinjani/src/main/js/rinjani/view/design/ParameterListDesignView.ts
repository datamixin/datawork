...
export default class ParameterListDesignView extends ConductorView implements HeightAdjustablePart {
	...
	public createControl(parent: Composite, index: number): void {
		...
		view.addClass(this.composite, "rinjani-parameter-list-design-view");
	...
	private createArgumentsLabel(parent: Composite): void {
		...
		label.setLineHeight(ParameterListDesignView.LABEL_HEIGHT);
		view.setGridData(label, true, ParameterListDesignView.LABEL_HEIGHT);
	}
	...
	public adjustHeight(): number {
		...
		return ParameterListDesignView.LABEL_HEIGHT + height;
	}
