...
export abstract class RinjaniPackage implements EPackage {

	public static eINSTANCE: RinjaniPackage = null;
	...
	abstract getEClassNames(): string[];

}

export default RinjaniPackage;
