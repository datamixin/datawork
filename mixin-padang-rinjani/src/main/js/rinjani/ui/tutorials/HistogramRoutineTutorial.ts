...
export default class HistogramRoutineTutorial extends ProjectTutorial {

	constructor() {
		super();
		super.setLabel("Histogram Routine");
		...
		super.clickText(".webface-popup-contents .menu-popup-action", "Routine...");

		super.click(".title-area-dialog-body .viewers-tableViewer-item:nth-child(3) :nth-child(1)");
		super.clickText(".dialog-shell .widgets-button", "OK");

		super.dragItem(".padang-value-field-anatomy-main-part", 1, ".rinjani-single-mapping-design-view");
...
registry.register(new HistogramRoutineTutorial());