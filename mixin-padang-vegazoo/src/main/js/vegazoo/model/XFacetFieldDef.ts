...
export default class XFacetFieldDef extends XFieldDef {

	public static XCLASSNAME: string = model.getEClassName("XFacetFieldDef");

	constructor(xClass?: EClass, features?: EFeature[]) {
		super(
			xClass ? xClass : model.createEClass(XFacetFieldDef.XCLASSNAME),
			features
		);
	}
