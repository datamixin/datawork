...
export abstract class VegazooPackage implements EPackage {

	public static eINSTANCE: VegazooPackage = null;
	...
	abstract listEClasses(): any[];

}

export default VegazooPackage;
