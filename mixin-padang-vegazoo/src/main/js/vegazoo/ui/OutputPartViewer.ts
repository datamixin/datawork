...
export default class OutputPartViewer extends GraphicPartViewer {
	...
	public createControl(parent: Composite) {
		...
		element.addClass("vegazoo-output-part-viewer");
	...
	public setContents(model: any): void {
		...
		let view = <OutlookOutputView>controller.getView();
		view.relayout();
