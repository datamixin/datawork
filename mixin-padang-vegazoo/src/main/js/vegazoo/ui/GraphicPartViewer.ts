...
export abstract class GraphicPartViewer extends BaseControllerViewer {

	protected premise: GraphicPremise;
	...
	public getGraphic(): XGraphic {
		return <XGraphic>this.premise.getModel();
	}

}

export default GraphicPartViewer;