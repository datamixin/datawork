...
export default class AreaTemplate implements DesignTemplate {

    public static MARK_TYPE = "area";
    ...
    public getEncodingRemapper(): ChannelEncodingRemapper {
        return new AreaEncodingRemapper();
    }

    public getMarkType(): string {
        return AreaTemplate.MARK_TYPE;
    }

    public getEncodingLabel(key: string): string {
        return AreaTemplate.ENCODING[key].label;
    }

}

class AreaEncodingRemapper extends ChannelEncodingRemapper {
...
factory.register(AreaTemplate.MARK_TYPE, new AreaTemplate());