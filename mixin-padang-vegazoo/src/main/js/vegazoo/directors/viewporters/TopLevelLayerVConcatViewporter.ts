...
export default class TopLevelVConcatSpecViewporter extends Viewporter {

}

let registry = ViewporterRegistry.getInstance();
registry.register(XTopLevelVConcatSpec.XCLASSNAME, new TopLevelVConcatSpecViewporter());
