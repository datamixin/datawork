...
export default class TopLevelHConcatSpecViewporter extends Viewporter {

}

let registry = ViewporterRegistry.getInstance();
registry.register(XTopLevelHConcatSpec.XCLASSNAME, new TopLevelHConcatSpecViewporter());
