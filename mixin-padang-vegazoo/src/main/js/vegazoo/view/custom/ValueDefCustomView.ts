...
export abstract class ValueDefCustomView extends ConductorView {

    private static CONTAINER_VERTICAL_INDENT = 5;
    ...
    public createControl(parent: Composite, index: number): void {
        ...
        element.addClass("vegazoo-value-def-custom-view");
    ...
    private createContainerPanel(parent: Composite): void {
        ...
        let layoutData = new GridData(true, 0);
        layoutData.verticalIndent = ValueDefCustomView.CONTAINER_VERTICAL_INDENT;
        control.setLayoutData(layoutData);
    ...
    public adjustHeight(): number {
        ...
        height += ValueDefCustomView.CONTAINER_VERTICAL_INDENT;
        return height;
    }
...
export default ValueDefCustomView;
