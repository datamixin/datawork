...
export default class AlgorithmCustomView extends ConductorView {
	...
	public createControl(parent: Composite, index: number): void {
		...
		element.addClass("malang-algorithm-custom-view");

		view.setGridLayout(this.composite, 1, 0, AlgorithmCustomView.VERTICAL_SPACING, 0, 0);
	...
	private createTitlePanel(parent: Composite): void {
		...
		view.css(this.titlePanel, "line-height", AlgorithmCustomView.HEIGHT + "px");
		view.setGridData(this.titlePanel, true, AlgorithmCustomView.HEIGHT);
	}
	...
	public adjustHeight(): number {
		...
		return height + AlgorithmCustomView.HEIGHT + AlgorithmCustomView.VERTICAL_SPACING * 2;
	}
