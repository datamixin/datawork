...
export default class ModelerCostomView extends ConductorView {
	...
	public createControl(parent: Composite, index: number): void {
		...
		element.addClass("malang-modeler-custom-view");

		view.setGridLayout(this.composite, 1, 0, ModelerCostomView.VERTICAL_SPACING, 0, 0);
	...
	private createTitlePanel(parent: Composite): void {
		...
		view.css(this.titlePanel, "line-height", ModelerCostomView.HEIGHT + "px");
		view.setGridData(this.titlePanel, true, ModelerCostomView.HEIGHT);
	}
	...
	public adjustHeight(): number {
		...
		return height + ModelerCostomView.HEIGHT + ModelerCostomView.VERTICAL_SPACING * 2;
	}
