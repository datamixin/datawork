...
export default class ModelConverter {
	...
	private ePackage = MalangPackage.eINSTANCE;
	...
	public convertModelToSpec(model: XModeler, mapping: ValueMapping): any {
	...
	private convertEObjectToSpec(eObject: EObject, mapping: ValueMapping): any {
