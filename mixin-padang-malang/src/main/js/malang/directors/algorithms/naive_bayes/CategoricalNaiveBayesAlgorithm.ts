...
import CategoricalNaiveBayes from "padang/functions/model/naive_bayes/CategoricalNaiveBayes";
...
export default class CategoricalNaiveBayesAlgorithm extends ClassificationAlgorithm {

	public static ALGORITHM_NAME = "CategoricalNaiveBayes";
	...
	public static getPlan(): AlgorithmPlan {
		...
		let base = CategoricalNaiveBayes.getPlan();
		let plan = new AlgorithmPlan(
			CategoricalNaiveBayesAlgorithm.ALGORITHM_NAME,
		...
		inputs.add(CategoricalNaiveBayesAlgorithm.FEATURES_PLAN);
		inputs.add(CategoricalNaiveBayesAlgorithm.TARGET_PLAN);
	...
	public execute(assignments: XAssignment[], result: string, callback: () => void): void {
		let plan = CategoricalNaiveBayesAlgorithm.getPlan();
		this.addModelFirst(plan, CategoricalNaiveBayes.FUNCTION_NAME, assignments);
...
registry.registerPlan(CategoricalNaiveBayesAlgorithm.getPlan());

let factory = AlgorithmFactory.getInstance();
factory.register(CategoricalNaiveBayesAlgorithm.ALGORITHM_NAME, CategoricalNaiveBayesAlgorithm);