...
export abstract class SupervisedModelChartPreload extends ModelChartPreload {

	protected checker: EstimatorChecker = null;

	constructor(name: string, group: string, sequence: number, presume: string, plan: AlgorithmPlan) {
...
export default SupervisedModelChartPreload;
