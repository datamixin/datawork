...
class GraphicContext(BaseContext):
    def __init__(self, parent: Context, provider: VariableProvider):
        super().__init__(parent)
        self._provider = provider

    def isFieldExists(self, variable: str) -> bool:
        if self._provider.isVariableExists(variable):
            return True
        else:
    ...
    def getField(self, variable: str):
        if self._provider.isVariableExists(variable):
            return self._provider.getVariable(variable)
        else:
