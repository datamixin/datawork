...
class LogicalEvaluation(Evaluation):
    def __init__(self, expression: EvaluateExpression):
        logical: EvaluateLogical = expression.logical
        self._value: bool = logical.value
...
factory.register(EvaluateExpression.logical.DESCRIPTOR.name, LogicalEvaluation)
