...
import com.andia.mixin.padang.garut.EvaluateNull;
import com.andia.mixin.padang.garut.EvaluateNull.Builder;

public class NullAdapter extends BaseAdapter {

	@Override
	public EvaluateExpression toExpression(Object object) {
		Builder nullBuilder = EvaluateNull.newBuilder();
		EvaluateNull evaluateNull = nullBuilder.build();
		EvaluateExpression.Builder expressionBuilder = EvaluateExpression.newBuilder();
		expressionBuilder.setNull(evaluateNull);
