...
export default class OvertopPartViewer extends BaseControllerViewer {
    ...
    public createControl(parent: Composite) {
        ...
        element.addClass("padang-overtop-part-viewer");
    ...
    private relayoutController(controller: Controller): void {
    ...
    public setContents(model: any): void {
        ...
        this.relayoutController(controller);
    ...
    public adjustHeight(): number {
        let contents = this.rootController.getContents();
        let part = <HeightAdjustablePart><any>contents.getView();
