...
export default class ToolboxPartViewer extends BaseControllerViewer {
    ...
    public createControl(parent: Composite) {
        ...
        element.addClass("padang-toolbox-part-viewer");
    ...
    public setContents(model: any): void {
        ...
        let view = <ProjectToolboxView>controller.getView();
        view.relayout();
