...
export default class ColumnExistsExamination extends Examination {

    public convertValue(value: VisageValue): any {
        return this.asLogical(value);
    }

}

let registry = ExaminationRegistry.getInstance();
registry.register(ColumnExists.FUNCTION_NAME, new ColumnExistsExamination());
