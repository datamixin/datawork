...
export default class ColumnTypesExamination extends Examination {

    public convertValue(value: VisageValue): any {
        return this.asConstantList(value);
    }

}

let registry = ExaminationRegistry.getInstance();
registry.register(ColumnTypes.FUNCTION_NAME, new ColumnTypesExamination());
