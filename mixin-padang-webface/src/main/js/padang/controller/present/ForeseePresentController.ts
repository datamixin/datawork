...
export abstract class ForeseePresentController extends EObjectController {
    ...
    public getView(): ForeseePresentView {
        return <ForeseePresentView>super.getView();
    }
...
export default ForeseePresentController;
