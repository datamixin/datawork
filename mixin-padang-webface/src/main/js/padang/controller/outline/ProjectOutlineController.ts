...
import ProjectOutlineView from "padang/view/outline/ProjectOutlineView";

export default class ProjectOutlineController extends EObjectController {
    ...
    public createView(): ProjectOutlineView {
        return new ProjectOutlineView(this);
    }
    ...
    public getView(): ProjectOutlineView {
        return <ProjectOutlineView>super.getView();
    }

    public getModelChildren(): any[] {
        let model = this.getModel();
        let sheets = model.getSheets();
        return [sheets];
    }
