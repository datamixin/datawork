...
import BuilderAnatomyView from "padang/view/anatomy/BuilderAnatomyView";

export default class BuilderAnatomyController extends EObjectController {
	...
	public createView(): BuilderAnatomyView {
		return new BuilderAnatomyView(this);
	}
	...
	public getView(): BuilderAnatomyView {
		return <BuilderAnatomyView>super.getView();
	}
