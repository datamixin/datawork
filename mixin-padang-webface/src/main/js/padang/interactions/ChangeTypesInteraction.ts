...
export default class ChangeTypesInteraction extends Interaction {

    constructor(
        public typeMap: any) {
        super(ChangeTypes.FUNCTION_NAME);
    }

    public static getPlan(): InteractionPlan {
        let plan = new InteractionPlan(ChangeTypes.getPlan());
...
registry.registerPlan(ChangeTypesInteraction.getPlan());