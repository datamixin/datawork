...
export default class PivotRowsInteraction extends Interaction {
	...
	constructor(
		...
		super(PivotRows.FUNCTION_NAME);
	}

	public static getPlan(): InteractionPlan {
		let plan = new InteractionPlan(PivotRows.getPlan());
...
registry.registerPlan(PivotRowsInteraction.getPlan());