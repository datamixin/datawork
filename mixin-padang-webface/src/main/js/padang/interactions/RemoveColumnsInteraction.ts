...
export default class RemoveColumnsInteraction extends Interaction {

    constructor(
        public keys: string[]) {
        super(RemoveColumns.FUNCTION_NAME);
    }

    public static getPlan(): InteractionPlan {
        let plan = new InteractionPlan(RemoveColumns.getPlan());
...
registry.registerPlan(RemoveColumnsInteraction.getPlan());