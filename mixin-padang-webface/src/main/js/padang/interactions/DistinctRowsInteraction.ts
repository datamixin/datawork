...
export default class DistinctRowsInteraction extends Interaction {

    constructor(
        public keys: any[]
    ) {
        super(DistinctRows.FUNCTION_NAME);
    }

    public static getPlan(): InteractionPlan {
        let plan = new InteractionPlan(DistinctRows.getPlan());
...
registry.registerPlan(DistinctRowsInteraction.getPlan());