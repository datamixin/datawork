...
export default class AddColumnInteraction extends Interaction {

    constructor(
        public name: string,
        public expression: string, ) {
        super(AddColumn.FUNCTION_NAME);
    }

    public static getPlan(): InteractionPlan {
        let plan = new InteractionPlan(AddColumn.getPlan());
...
registry.registerPlan(AddColumnInteraction.getPlan());