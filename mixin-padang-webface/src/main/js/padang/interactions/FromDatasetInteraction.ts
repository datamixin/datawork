...
export default class FromDatasetInteraction extends Interaction {
	...
	public static getPlan(): InteractionPlan {
		let plan = new InteractionPlan(FromDataset.getPlan(), 100);
...
registry.registerPlan(FromDatasetInteraction.getPlan());