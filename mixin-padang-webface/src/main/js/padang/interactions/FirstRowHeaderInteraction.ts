...
export default class FirstRowHeaderInteraction extends Interaction {

    constructor() {
        super(FirstRowHeader.FUNCTION_NAME);
    }

    public static getPlan(): InteractionPlan {
        let plan = new InteractionPlan(FirstRowHeader.getPlan());
        return plan;
    }
...
registry.registerPlan(FirstRowHeaderInteraction.getPlan());