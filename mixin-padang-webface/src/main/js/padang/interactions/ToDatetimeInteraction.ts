...
export default class ToDatetimeInteraction extends Interaction {

    constructor(
        public column: string,
        public format: string) {
        super(ToDatetime.FUNCTION_NAME);
    }

    public static getPlan(): InteractionPlan {
        let plan = new InteractionPlan(ToDatetime.getPlan());
...
registry.registerPlan(ToDatetimeInteraction.getPlan());