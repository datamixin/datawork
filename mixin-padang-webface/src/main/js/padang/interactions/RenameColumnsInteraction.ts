...
export default class RenameColumnsInteraction extends Interaction {

    constructor(
        public nameMap: { [oldName: string]: string }) {
        super(RenameColumns.FUNCTION_NAME);
    }

    public static getPlan(): InteractionPlan {
        let plan = new InteractionPlan(RenameColumns.getPlan());
...
registry.registerPlan(RenameColumnsInteraction.getPlan());