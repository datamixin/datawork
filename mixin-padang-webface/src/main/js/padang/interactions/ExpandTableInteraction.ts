...
export default class ExpandTableInteraction extends Interaction {

	constructor(
		public column: string,
		public includes: string[]
	) {
		super(ExpandTable.FUNCTION_NAME);
	}

	public static getPlan(): InteractionPlan {
		let plan = new InteractionPlan(ExpandTable.getPlan());
...
registry.registerPlan(ExpandTableInteraction.getPlan());