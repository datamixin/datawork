...
export default class Example extends Function {

    public static FUNCTION_NAME = "Example";

    constructor(
        public value: any) {
        super(Example.FUNCTION_NAME);
    }
...
registry.registerPlan(Example.getPlan());