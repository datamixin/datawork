...
export default class PreparationPrepareView extends ConductorView {

    private static MUTATIONS_WIDTH = 290;
    ...
    private createContainer(parent: Composite): void {
        ...
        view.setGridLayout(this.container, 2, 0, 0, 0, 0);
    ...
    public addView(child: ConductorView, index: number): void {
        ...
        if (child instanceof MutationListPrepareView) {
            view.setGridData(child, PreparationPrepareView.MUTATIONS_WIDTH, true);
        } else {
